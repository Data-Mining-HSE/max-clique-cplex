...
class ExperiemntResult:
    ...
    def show(self) -> None:
        msg = f'Graph: {self.graph_name}. Clique is found: {self.is_clique and int(self.founded_clique) == int(self.max_clique)}. Size {self.founded_clique} (Best {self.max_clique}). Time {self.time:.2f}.'
